	...
	<div class="container">
		...
		<div class="single-pro">
			...
			<div class="col-md-3 product-men">
				<div class="men-pro-item simpleCart_shelfItem">
					<div class="men-thumb-item">
						<img src="{{asset($publishCategoryProduct->productImage)}}" height="300" width="220" alt="" class="pro-image-front">
						<img src="{{asset($publishCategoryProduct->productImage)}}" height="300" width="220" alt="" class="pro-image-back">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="single.html" class="link-product-add-cart">Quick View</a>
								</div>
					...
					<div class="item-info-product ">
						...
						<div class="info-product-price">
							<span class="item_price"><font size="3" color="red">BDT</font>{{$publishCategoryProduct->productPrice}}</span>
							<del>$69.71</del>
						</div>
						<a href="#" class="item_add single-item hvr-outline-out button2">Add to cart</a>
					</div>
