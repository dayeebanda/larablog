						...
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{asset($publishProduct->productImage)}}" height="300" width="220" alt="" class="pro-image-front">
									<img src="{{asset($publishProduct->productImage)}}" height="300" width="220" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="{{ url('/product-details/'.$publishProduct->id)}}" class="link-product-add-cart">Quick View</a>
											</div>
										</div>
								...
								<div class="item-info-product ">
									<h4><a href="single.html">{{$publishProduct->productName}}</a></h4>
									<div class="info-product-price">
										<span class="item_price">${{$publishProduct->productPrice}}</span>
										<del>$69.71</del>
									</div>
